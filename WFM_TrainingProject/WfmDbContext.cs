...
namespace WFM_TrainingProject
{
    public class WfmDbContext:DbContext
    {
        ...
        private static void ConfigureModels(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Softlocks>().Property(x => x.requestmessage).HasColumnType("varchar");
            modelBuilder.Entity<Softlocks>().Property(x => x.wfmremark).HasColumnType("varchar");
            ...
            modelBuilder.Entity<Softlocks>().Property(x => x.mgrstatuscomment).HasColumnType("varchar");
